...
#lasfm
list_lastfm = {
    'list_friend': load_list('data_raw/lastfm/List_friend.txt'),
    'list_category': load_list('data_raw/lastfm/List_category.txt')
}
...
#lastfm
def user_converting_lf(user_row, friend_list):
    # friend_dim: 1892
    friend_idx = [0] * 1892
