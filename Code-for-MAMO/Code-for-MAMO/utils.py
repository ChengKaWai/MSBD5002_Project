...
# ===================== Load data ==========================
def train_test_user_list(dataset='lastfm', rand=True, random_state=32, train_test_split_ratio=0.8, store=False):
...
def load_user_info(user_id, dataset='lastfm', support_size=16, query_size=4, device=torch.device('cpu')):
    path = 'data_processed/' + dataset + '/raw/'
